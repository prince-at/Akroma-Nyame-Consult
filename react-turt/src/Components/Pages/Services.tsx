import serviceImage from "../../assets/front-view-couple-holding-passport.jpg"
...
const Services = (props: Props) => {
  return (
    ...
    <div>
      ...
      <h2 className='services-subtitle'>Empowering Talent. Enabling Travel. Building Global Careers.</h2>
